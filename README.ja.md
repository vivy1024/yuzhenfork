...
**v1.3.11 Studio サービス / 集約 API 更新** — [kkaiapi](https://en.kkaiapi.com) をモデルサービス選択肢に追加し、カスタム / ローカルモデルの接続テスト、非 ASCII API Key によるクラッシュ、サービス設定削除、レーダー履歴、ジャンル管理更新、長編の複数ライン比率反映を改善しました。
