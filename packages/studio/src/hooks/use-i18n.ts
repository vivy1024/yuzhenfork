...
const strings = {
  ...
  "doctor.projectConfig": { zh: "novelfork.json 配置", en: "novelfork.json configuration" },
  "doctor.projectEnv": { zh: "项目 .env 文件", en: "Project .env file" },
  "doctor.globalEnv": { zh: "全局 ~/.novelfork/.env", en: "Global ~/.novelfork/.env" },
  ...
  "doctor.workspaceConfig": { zh: "工作区配置 (novelfork.json)", en: "Workspace Config (novelfork.json)" },
