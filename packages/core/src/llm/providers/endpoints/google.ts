...
export const GOOGLE: InkosEndpoint = {
  ...
  models: [
    ...
    { id: "gemini-3.1-flash-image-preview", maxOutput: 32768, contextWindowTokens: 163840, enabled: false, releasedAt: "2026-02-26" },
    ...
    { id: "gemini-3-pro-image-preview", maxOutput: 32768, contextWindowTokens: 163840, enabled: false, releasedAt: "2025-11-20" },
    ...
    { id: "gemini-2.5-flash-image", maxOutput: 32768, contextWindowTokens: 98304, enabled: false, releasedAt: "2025-08-26" },
