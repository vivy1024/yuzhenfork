...
export const BAILIAN_CODING_PLAN: InkosEndpoint = {
  ...
  models: [
    { id: "qwen3.5-plus", displayName: "Qwen3.5 Plus", maxOutput: 65536, contextWindowTokens: 1000000, enabled: true, releasedAt: "2026-02-15" },
    { id: "qwen3-coder-plus", displayName: "Qwen3 Coder Plus", maxOutput: 65536, contextWindowTokens: 1000000, releasedAt: "2025-09-23" },
    { id: "qwen3-max-2026-01-23", displayName: "Qwen3 Max", maxOutput: 65536, contextWindowTokens: 262144, enabled: true, releasedAt: "2026-01-23" },
    { id: "qwen3-coder-next", displayName: "Qwen3 Coder Next", maxOutput: 65536, contextWindowTokens: 262144, releasedAt: "2026-02-15" },
